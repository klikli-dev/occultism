...
public class CrusherDjinniEntry extends EntryProvider {
    ...
    public static final String ENTRY_ID = "summon_crusher_t2";

    public CrusherDjinniEntry(CategoryProvider parent) {
        super(parent);
    }

    @Override
    protected BookIconModel entryIcon() {
        return BookIconModel.create(OccultismItems.IRON_DUST);
    }

    @Override
    protected String entryName() {
        return "Summon Djinni Crusher";
    }
