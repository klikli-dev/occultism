...
public class PentaclesCategory extends CategoryProvider {
    ...
    protected void generateEntries() {
        ...
        paraphernaliaEntry.withParent(BookEntryParentModel.create(overviewEntry.getId()).withLineReversed(true))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_OVERVIEW, overviewEntry));
        ...
        whiteChalkEntry.withParent(BookEntryParentModel.create(didacticsEntry.getId()).withLineReversed(true))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_DIDACTICS, didacticsEntry));
        ...
        summonFoliot.withParent(BookEntryParentModel.create(didacticsEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_WHITE_CHALK, whiteChalkEntry));
        ...
        lightGrayChalkEntry.withParent(BookEntryParentModel.create(whiteChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_SUMMON_FOLIOT, summonFoliot));
        ...
        possessFoliot.withParent(BookEntryParentModel.create(yellowChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_YELLOW_CHALK, yellowChalkEntry));
        ...
        purpleChalkEntry.withParent(BookEntryParentModel.create(yellowChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_POSSESS_FOLIOT, possessFoliot));
        ...
        craftFoliot.withParent(BookEntryParentModel.create(purpleChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_PURPLE_CHALK, purpleChalkEntry));
        ...
        limeChalkEntry.withParent(BookEntryParentModel.create(purpleChalkEntry.getId()).withLineReversed(true))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_CRAFT_FOLIOT, craftFoliot));
        ...
        summonDjinni.withParent(BookEntryParentModel.create(summonFoliot.getId()))
                .withCondition(
                        this.condition().and(
                                this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_LIGHT_GRAY_CHALK, lightGrayChalkEntry),
                                this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_LIME_CHALK, limeChalkEntry)
                        ));
        ...
        lightBlueChalkEntry.withParent(BookEntryParentModel.create(summonDjinni.getId()).withLineEnabled(false))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_SUMMON_DJINNI, summonDjinni));
        ...
        orangeChalkEntry.withParent(BookEntryParentModel.create(limeChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_POSSESS_DJINNI, possessDjinni));
        ...
        grayChalkEntry.withParent(BookEntryParentModel.create(lightGrayChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_CRAFT_DJINNI, craftDjinni));
        ...
        summonUnboundAfrit.withParent(BookEntryParentModel.create(summonDjinni.getId()))
                .withCondition(
                        this.condition().and(
                                this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_GRAY_CHALK, grayChalkEntry),
                                this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_ORANGE_CHALK, orangeChalkEntry)
                        ));
        ...
        redChalkEntry.withParent(BookEntryParentModel.create(orangeChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_SUMMON_UNBOUND_AFRIT, summonUnboundAfrit));
        ...
        pinkChalkEntry.withParent(BookEntryParentModel.create(possessUnboundAfrit.getId()).withLineEnabled(false))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_POSSESS_UNBOUND_AFRIT, possessUnboundAfrit));
        ...
        contactWildSpirit
                ...
                .withCondition(
                        this.condition().and(
                                this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_PINK_CHALK, pinkChalkEntry),
                                this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_GREEN_CHALK, greenChalkEntry),
                                this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_LIGHT_BLUE_CHALK, lightBlueChalkEntry)
                        ));
        ...
        summonAfrit.withParent(BookEntryParentModel.create(summonUnboundAfrit.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_RED_CHALK, redChalkEntry));
        ...
        blackChalkEntry.withParent(BookEntryParentModel.create(grayChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_CRAFT_AFRIT, craftAfrit));
        ...
        summonUnboundMarid.withParent(BookEntryParentModel.create(summonAfrit.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_BLACK_CHALK, blackChalkEntry));
        ...
        blueChalkEntry.withParent(BookEntryParentModel.create(redChalkEntry.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_SUMMON_UNBOUND_MARID, summonUnboundMarid));
        ...
        summonMarid.withParent(BookEntryParentModel.create(summonUnboundMarid.getId()))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_BLUE_CHALK, blueChalkEntry));
        ...
        cyanChalkEntry.withParent(BookEntryParentModel.create(summonMarid.getId()).withLineEnabled(false))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_SUMMON_MARID, summonMarid));
        ...
        brownChalkEntry.withParent(BookEntryParentModel.create(possessMarid.getId()).withLineEnabled(false))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_POSSESS_MARID, possessMarid));
        ...
        magentaChalkEntry.withParent(BookEntryParentModel.create(craftMarid.getId()).withLineEnabled(false))
                .withCondition(this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_CRAFT_MARID, craftMarid));
        ...
        contactEldritch
                ...
                .withCondition(this.condition().and(
                        this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_MAGENTA_CHALK, magentaChalkEntry),
                        this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_BROWN_CHALK, brownChalkEntry),
                        this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_CYAN_CHALK, cyanChalkEntry),
                        this.condition().researchNodeEntryViewedOnce(OccultismResearch.PENTACLES_CONTACT_WILD, contactWildSpirit)
                ));
