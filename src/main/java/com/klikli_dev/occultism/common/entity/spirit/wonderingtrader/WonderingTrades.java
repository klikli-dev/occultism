...
public class WonderingTrades {
    ...
    public static Byte2ObjectMap<ItemListing[]> WONDERING_TRADES = new Byte2ObjectOpenHashMap<>(Map.of(
            ...
            MATERIAL, new ItemListing[]{
                    ...
                    new ItemTrade(new ItemStack(Items.GLAZED_TERRACOTTA.brown(), 1),
            ...
            STORAGE, new ItemListing[]{
                    ...
                    new ItemTrade(new ItemStack(Items.COPPER_BLOCK.weathering().unaffected(), 4),
            ...
            DYE, new ItemListing[]{
                    ...
                    new ItemTrade(new ItemStack(Items.DYE.lightGray(), 64),
                            new ItemStack(Items.HEAVY_CORE), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.gray(), 64),
                            new ItemStack(Items.REINFORCED_DEEPSLATE), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.black(), 64),
                            new ItemStack(Items.NETHERITE_BLOCK), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.brown(), 64),
                            new ItemStack(Items.ENCHANTED_GOLDEN_APPLE), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.brown(), 64),
                            new ItemStack(OccultismItems.PITAYA_ENCHANTED.get()), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.red(), 64),
                            new ItemStack(Items.BELL), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.orange(), 64),
                    ...
                    new ItemTrade(new ItemStack(Items.DYE.lightBlue(), 64),
                            new ItemStack(OccultismBlocks.IESNIUM_BLOCK.get()), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.blue(), 64),
                            new ItemStack(Items.SOUL_LANTERN), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.purple(), 64),
                            new ItemStack(Items.RESPAWN_ANCHOR), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.magenta(), 64),
                            new ItemStack(Items.BUDDING_AMETHYST), 1, 1),
                    new ItemTrade(new ItemStack(Items.DYE.pink(), 64),
