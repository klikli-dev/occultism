...
public class DragonFamiliarModel extends EntityModel<DragonFamiliarEntity> {
    ...
    public DragonFamiliarModel() {
        ...
        this.setRotateAngle(this.leftHorn1, 0.22689280275926282F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightArm3, 0.0F, 0.0F, -0.7853981633974483F);
        ...
        this.setRotateAngle(this.leftLeg3, 0.3909537457888271F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.leftLeg1, 0.4300491170387584F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightArm2, 0.0F, 0.0F, 0.7853981633974483F);
        ...
        this.setRotateAngle(this.rightEar, -0.13613568498450906F, -1.1798425477165557F, 0.5899212738582779F);
        ...
        this.setRotateAngle(this.head, 0.8213519699569813F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.body, -0.06981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.leftArm3, 0.0F, 0.0F, -0.7853981633974483F);
        ...
        this.setRotateAngle(this.tail2, -0.23457224414434488F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.tail3, 0.19547687289441354F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightHorn1, 0.22689280275926282F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightLeg2, -0.7428121536172364F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.neck1, -0.5473352640780661F, 0.0F, 0.0F);
        this.spike2 = new ModelRenderer(this, 0, 25);
        this.spike2.setPos(0.0F, -4.0F, 0.0F);
        ...
        this.setRotateAngle(this.leftEar, -0.13613568498450906F, 1.1798425477165557F, -0.5899212738582779F);
        ...
        this.setRotateAngle(this.neck2, -0.1563815016444822F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.leftWing2, 0.0F, 0.0F, 0.8600982340775168F);
        ...
        this.setRotateAngle(this.leftWing1, 0.0F, 0.0F, 0.7504915783575618F);
        ...
        this.setRotateAngle(this.leftArm2, 0.0F, 0.0F, 0.7853981633974483F);
        ...
        this.setRotateAngle(this.rightWing1, 0.0F, 0.0F, -0.7428121536172364F);
        ...
        this.setRotateAngle(this.rightWing2, 0.0F, 0.0F, -0.8600982340775168F);
        ...
        this.setRotateAngle(this.tail1, -0.23457224414434488F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightLeg3, 0.3909537457888271F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightLeg1, 0.4300491170387584F, 0.0F, 0.0F);
        ...
        this.spike3.setPos(0.01F, -3.5F, 0.0F);
        ...
        this.setRotateAngle(this.leftHorn2, 0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightHorn2, 0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.leftLeg2, -0.7428121536172364F, 0.0F, 0.0F);
    ...
    public void prepareMobModel(DragonFamiliarEntity entityIn, float limbSwing, float limbSwingAmount,
        ...
        if (!entityIn.isSitting()) {
            ...
            this.leftWing1.zRot = this.toRads(65)
                    + MathHelper.cos(limbSwing * 0.7f + flyingWingRot) * (limbSwingAmount * 0.2f + this.toRads(wingspan));
            ...
            this.tail1.xRot = MathHelper.cos(ageInTicks / 20) * this.toRads(10);
            this.tail2.xRot = MathHelper.cos(ageInTicks / 20) * this.toRads(10);
            this.tail3.xRot = MathHelper.cos(ageInTicks / 20) * this.toRads(10);
