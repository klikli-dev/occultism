...
public abstract class SpiritJobRecipes extends RecipeProvider {
    ...
    private static void spiritTradeRecipes(RecipeOutput pRecipeOutput) {
        ...
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.STONES),
                ...
                .unlockedBy("has_stone", has(Tags.Items.STONES))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/stone_to_otherrock"));
        ...
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                ...
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_spirit"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.DIAMOND, 1), 1,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_diamond"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.EMERALD, 1), 1,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_emerald"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.QUARTZ, 1), 2,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_quartz"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.LAPIS_LAZULI, 1), 2,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_lazuli"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.PRISMARINE_CRYSTALS, 1), 4,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_prismarine"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.AMETHYST_SHARD, 1), 4,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_amethyst"));

        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.IRON_NUGGET, 1), 16,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_iron"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(Items.GOLD_NUGGET, 1), 8,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_gold"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(OccultismItems.SILVER_NUGGET.get(), 1), 8,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_silver"));
        SpiritTradeRecipeBuilder.spiritTradeRecipe(Ingredient.of(Tags.Items.GEMS),
                        new ItemStack(OccultismItems.IESNIUM_NUGGET.get(), 1), 1,
                        "occultism:gambler")
                .unlockedBy("has_gems", has(Tags.Items.GEMS))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "spirit_trade/gambler_iesnium"));
    }
    ...
    private static void blockProcessRecipes(RecipeOutput pRecipeOutput) {
        ...
        CrystallizeRecipeBuilder.crystallizeRecipe(OccultismTags.Items.OTHERROCK_DUST, OccultismBlocks.OTHERROCK, 200)
                ...
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "crystallize/otherrock"));
    ...
    protected static void crushingGeneralizedRecipe(String input, Integer amount, String from, Boolean mult, RecipeOutput recipeOutput) {
        CrushingRecipeBuilder.crushingRecipe(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", from + "s/" + input)), OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", "dusts/" + input)), 200)
                .unlockedBy("has_" + input + "_" + from, has(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", from + "s/" + input))))
                .setResultAmount(amount)
                .setAllowEmpty(false)
                .setIgnoreCrushingMultiplier(mult)
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "crushing/" + input + "_dust_from_" + from));
    }
    ...
    protected static void crystallizeGeneralizedRecipe(String input, Integer amount, String from, Boolean mult, RecipeOutput recipeOutput) {
        CrystallizeRecipeBuilder.crystallizeRecipe(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", from + "s/" + input)), OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", "gems/" + input)), 200)
                .unlockedBy("has_" + input + "_" + from, has(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", from + "s/" + input))))
                .setResultAmount(amount)
                .setAllowEmpty(false)
                .setIgnoreCrystallizeMultiplier(mult)
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "crystallize/" + input + "_from_" + from));
    }
    ...
    private static void doubleCookingRecipe(String metalName, Item output, RecipeOutput recipeOutput) {
        ...
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", "dusts/" + metalName))), RecipeCategory.MISC, output, 0.7f, 200)
                .unlockedBy("has_" + metalName + "_dust", has(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", "dusts/" + metalName))))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "smelting/" + outputString + "_from_dust"));

        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", "dusts/" + metalName))), RecipeCategory.MISC, output, 0.7f, 100)
                .unlockedBy("has_" + metalName + "_dust", has(OccultismTags.makeItemTag(ResourceLocation.fromNamespaceAndPath("c", "dusts/" + metalName))))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Occultism.MODID, "blasting/" + outputString + "_from_dust"));
    }
