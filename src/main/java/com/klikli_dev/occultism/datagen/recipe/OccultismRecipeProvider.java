...
public class OccultismRecipeProvider extends RecipeProvider {
    ...
    private void stonecutterRecipes(RecipeOutput pRecipeOutput, Provider registries) {
        ...
        otherStonecutter(pRecipeOutput, OccultismBlocks.CHISELED_OTHERSTONE_BRICKS, OccultismBlocks.OTHERSTONE, items);
        otherStonecutter(pRecipeOutput, OccultismBlocks.CHISELED_OTHERSTONE_BRICKS, OccultismBlocks.OTHERSTONE_BRICKS, items);
        ...
        otherStonecutter(pRecipeOutput, OccultismBlocks.CHISELED_OTHERROCK_BRICKS, OccultismBlocks.OTHERROCK, items);
    ...
    private void metalRecipes(RecipeOutput pRecipeOutput, HolderGetter<Item> items) {
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.SILVER_HELMET.get())
                .pattern("ppp")
                .pattern("p p")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_helmet")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.SILVER_CHESTPLATE.get())
                .pattern("p p")
                .pattern("ppp")
                .pattern("ppp")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_chestplate")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.SILVER_LEGGINGS.get())
                .pattern("ppp")
                .pattern("p p")
                .pattern("p p")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_leggings")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.SILVER_BOOTS.get())
                .pattern("p p")
                .pattern("p p")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_boots")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.SILVER_SWORD.get())
                .pattern("p")
                .pattern("p")
                .pattern("s")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                ...
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_sword")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.SILVER_SPEAR.get())
                .pattern("  p")
                .pattern(" s ")
                .pattern("s  ")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .define('s', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_spear")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.TOOLS, OccultismItems.SILVER_AXE.get())
                .pattern("pp")
                .pattern("ps")
                .pattern(" s")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .define('s', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_axe")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.TOOLS, OccultismItems.SILVER_PICKAXE.get())
                .pattern("ppp")
                .pattern(" s ")
                .pattern(" s ")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .define('s', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_pickaxe")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.TOOLS, OccultismItems.SILVER_SHOVEL.get())
                .pattern("p")
                .pattern("s")
                .pattern("s")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .define('s', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_shovel")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.SILVER_HOE.get())
                .pattern("pp")
                .pattern(" s")
                .pattern(" s")
                .define('p', OccultismTags.Items.SILVER_INGOT)
                .define('s', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_hoe")));
    }
...
//                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/book_of_binding_bound_marid")));
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.COMBAT, OccultismItems.BUTCHER_KNIFE.get())
                ...
                .pattern("is ")
                .pattern("s  ")
                .define('i', OccultismTags.Items.SILVER_INGOT)
                .define('s', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_silver_ingot", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/butcher_knife_silver")));
        ...
        this.stairBuilder(OccultismBlocks.OTHERSTONE_STAIRS.get(), Ingredient.of(OccultismBlocks.OTHERSTONE.asItem()))
                .unlockedBy("has_otherstone", TriggerInstance.hasItems(OccultismBlocks.OTHERSTONE.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherstone_stairs")));
        ...
        this.buttonBuilder(OccultismBlocks.OTHERSTONE_BUTTON.get(), Ingredient.of(OccultismBlocks.OTHERSTONE.asItem()))
                .unlockedBy("has_otherstone", TriggerInstance.hasItems(OccultismBlocks.OTHERSTONE.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherstone_button")));
        ...
        this.stairBuilder(OccultismBlocks.OTHERCOBBLESTONE_STAIRS.get(), Ingredient.of(OccultismBlocks.OTHERCOBBLESTONE.asItem()))
                .unlockedBy("has_othercobblestone", TriggerInstance.hasItems(OccultismBlocks.OTHERCOBBLESTONE.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/othercobblestone_stairs")));
        ...
        this.stairBuilder(OccultismBlocks.POLISHED_OTHERSTONE_STAIRS.get(), Ingredient.of(OccultismBlocks.POLISHED_OTHERSTONE.asItem()))
                .unlockedBy("has_polished_otherstone", TriggerInstance.hasItems(OccultismBlocks.POLISHED_OTHERSTONE.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/polished_otherstone_stairs")));
        ...
        this.stairBuilder(OccultismBlocks.OTHERSTONE_BRICKS_STAIRS.get(), Ingredient.of(OccultismBlocks.OTHERSTONE_BRICKS.asItem()))
                .unlockedBy("has_otherstone_bricks", TriggerInstance.hasItems(OccultismBlocks.OTHERSTONE_BRICKS.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherstone_bricks_stairs")));
        ...
        this.stairBuilder(OccultismBlocks.OTHERROCK_STAIRS.get(), Ingredient.of(OccultismBlocks.OTHERROCK.asItem()))
                .unlockedBy("has_otherrock", TriggerInstance.hasItems(OccultismBlocks.OTHERROCK.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherrock_stairs")));
        ...
        this.buttonBuilder(OccultismBlocks.OTHERROCK_BUTTON.get(), Ingredient.of(OccultismBlocks.OTHERROCK.asItem()))
                .unlockedBy("has_otherrock", TriggerInstance.hasItems(OccultismBlocks.OTHERROCK.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherrock_button")));
        ...
        this.stairBuilder(OccultismBlocks.OTHERCOBBLEROCK_STAIRS.get(), Ingredient.of(OccultismBlocks.OTHERCOBBLEROCK.asItem()))
                .unlockedBy("has_othercobblerock", TriggerInstance.hasItems(OccultismBlocks.OTHERCOBBLEROCK.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/othercobblerock_stairs")));
        ...
        this.stairBuilder(OccultismBlocks.POLISHED_OTHERROCK_STAIRS.get(), Ingredient.of(OccultismBlocks.POLISHED_OTHERROCK.asItem()))
                .unlockedBy("has_polished_otherrock", TriggerInstance.hasItems(OccultismBlocks.POLISHED_OTHERROCK.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/polished_otherrock_stairs")));
        ...
        this.stairBuilder(OccultismBlocks.OTHERROCK_BRICKS_STAIRS.get(), Ingredient.of(OccultismBlocks.OTHERROCK_BRICKS.asItem()))
                .unlockedBy("has_otherrock_bricks", TriggerInstance.hasItems(OccultismBlocks.OTHERROCK_BRICKS.asItem()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherrock_bricks_stairs")));
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_CHISELED_BLOCK.get())
                .pattern("o")
                .pattern("o")
                .define('o', OccultismBlocks.SILVER_CUT_SLAB.get())
                .unlockedBy("has_cut_silver_slab", TriggerInstance.hasItems(OccultismBlocks.SILVER_CUT_SLAB.get()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/chiseled_silver")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_GRATE_BLOCK.get(), 4)
                .pattern(" o ")
                .pattern("o o")
                .pattern(" o ")
        ...
        this.stairBuilder(OccultismBlocks.SILVER_CUT_STAIRS.get(), Ingredient.of(OccultismBlocks.SILVER_CUT_BLOCK.asItem()))
                ...
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/cut_silver_stairs")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_CUT_SLAB.get(), 6)
                .pattern("ooo")
                .define('o', OccultismBlocks.SILVER_CUT_BLOCK.get())
                .unlockedBy("has_cut_silver", TriggerInstance.hasItems(OccultismBlocks.SILVER_CUT_BLOCK.get()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/cut_silver_slab")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_BARS_BLOCK.get(), 16)
                .pattern("ooo")
                .pattern("ooo")
                .define('o', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_bars")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_CHAIN_BLOCK.get())
                .pattern("n")
                .pattern("i")
                .pattern("n")
                .define('n', OccultismTags.Items.SILVER_NUGGET)
                .define('i', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_chain")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_DOOR.get(), 3)
                .pattern("oo")
                .pattern("oo")
                .pattern("oo")
                .define('o', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver", this.has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_door")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_TRAPDOOR.get())
                .pattern("oo")
                .pattern("oo")
                .define('o', OccultismTags.Items.SILVER_INGOT)
                .unlockedBy("has_silver", this.has(OccultismTags.Items.SILVER_INGOT))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_BULB.get(), 4)
                ...
                .unlockedBy("has_silver_block", this.has(OccultismTags.Items.STORAGE_BLOCK_SILVER))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/silver_bulb")));
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.TOOLS, OccultismItems.FAMILIAR_TABLET.get())
                ...
                .define('s', Ingredient.of(Items.GOLDEN_DANDELION, Items.SUNFLOWER))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.DECORATIONS, OccultismBlocks.SPIRIT_LANTERN.get())
                ...
                .pattern("X#X")
                .pattern("XXX")
                .define('X', OccultismTags.Items.SILVER_NUGGET)
    ...
    private void woodRecipes(RecipeOutput pRecipeOutput, HolderGetter<Item> items) {
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.DECORATIONS, OccultismBlocks.OTHERPLANKS_SHELF, 6)
                .define('#', OccultismBlocks.STRIPPED_OTHERWORLD_LOG.asItem())
                .pattern("###")
                .pattern("   ")
                .pattern("###")
                .group("shelf")
                .unlockedBy("has_stripped_otherworld_log", TriggerInstance.hasItems(OccultismBlocks.STRIPPED_OTHERWORLD_LOG.get()))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherplanks_shelf")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.TRANSPORTATION, OccultismItems.OTHERPLANKS_BOAT)
                .define('#', OccultismBlocks.OTHERPLANKS.asItem())
                .pattern("# #")
                .pattern("###")
                .group("boat")
                .unlockedBy("in_water", insideOf(Blocks.WATER))
                .save(pRecipeOutput, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Occultism.MODID, "crafting/otherplanks_boat")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.TRANSPORTATION, OccultismItems.OTHERPLANKS_BOAT_CHEST)
                .requires(Blocks.CHEST)
                .requires(OccultismItems.OTHERPLANKS_BOAT)
                .group("chest_boat")
