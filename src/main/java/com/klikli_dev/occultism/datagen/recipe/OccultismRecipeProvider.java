...
public class OccultismRecipeProvider extends RecipeProvider {
    ...
    private static void metalRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.IESNIUM_BLOCK.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/iesnium_block"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.IESNIUM_INGOT.get(), 9)
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/iesnium_ingot_from_block"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.IESNIUM_INGOT.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/iesnium_ingot_from_nuggets"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.IESNIUM_NUGGET.get(), 9)
                ...
                .unlockedBy("has_iesnium_ingot", has(OccultismTags.Items.IESNIUM_INGOT))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/iesnium_nugget"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismBlocks.RAW_IESNIUM_BLOCK.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/raw_iesnium_block"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.RAW_IESNIUM.get(), 9)
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/raw_iesnium_ingot_from_block"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SILVER_BLOCK.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/silver_block"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.SILVER_INGOT.get(), 9)
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/silver_ingot_from_block"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.SILVER_INGOT.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/silver_ingot_from_nuggets"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.SILVER_NUGGET.get(), 9)
                ...
                .unlockedBy("has_silver_ingot", has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/silver_nugget"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismBlocks.RAW_SILVER_BLOCK.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/raw_silver_block"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.RAW_SILVER.get(), 9)
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/raw_silver_ingot_from_block"));
    }
    ...
    private static void blastingRecipes(RecipeOutput pRecipeOutput) {
        SimpleCookingRecipeBuilder
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/copper_ingot_from_dust"));
        SimpleCookingRecipeBuilder
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/gold_ingot_from_dust"));
        SimpleCookingRecipeBuilder
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/iesnium_ingot"));
        SimpleCookingRecipeBuilder
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/iesnium_ingot_from_dust"));

        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(OccultismTags.Items.RAW_IESNIUM), RecipeCategory.MISC, OccultismItems.IESNIUM_INGOT.get(), 0.7f, 100)
                .unlockedBy("has_raw_iesnium", has(OccultismTags.Items.RAW_IESNIUM))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/iesnium_ingot_from_raw"));
        SimpleCookingRecipeBuilder
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/iron_ingot_from_dust"));
        SimpleCookingRecipeBuilder
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/silver_ingot"));
        SimpleCookingRecipeBuilder
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/silver_ingot_from_dust"));
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(OccultismTags.Items.RAW_SILVER), RecipeCategory.MISC, OccultismItems.SILVER_INGOT.get(), 0.7f, 100)
                .unlockedBy("has_raw_silver", has(OccultismTags.Items.RAW_SILVER))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "blasting/silver_ingot_from_raw"));
    }
    ...
    private void miningRecipes(RecipeOutput pRecipeOutput) {
        MinerRecipeBuilder.minerRecipe(OccultismTags.Items.Miners.MASTER, OccultismTags.makeItemTag(new ResourceLocation("c", "ores/stella_arcanum")), 100)
                .unlockedBy("has_stella_arcanum_ore", has(OccultismTags.makeItemTag(new ResourceLocation("c", "ores/stella_arcanum"))))
    ...
    private void crushingGemRecipe(String gemName, RecipeOutput recipeOutput) {
        CrushingRecipeBuilder.crushingRecipe(OccultismTags.makeItemTag(new ResourceLocation("c", "ores/" + gemName)), OccultismTags.makeItemTag(new ResourceLocation("c", "dusts/" + gemName)), 200)
                .unlockedBy("has_" + gemName, has(OccultismTags.makeItemTag(new ResourceLocation("c", "ores/" + gemName))))
                .setResultAmount(4)
                .setAllowEmpty(false)
                .save(recipeOutput, new ResourceLocation(Occultism.MODID, "crushing/" + gemName + "_dust"));

        CrushingRecipeBuilder.crushingRecipe(OccultismTags.makeItemTag(new ResourceLocation("c", "gems/" + gemName)), OccultismTags.makeItemTag(new ResourceLocation("c", "dusts/" + gemName)), 200)
                .unlockedBy("has_" + gemName + "_gem", has(OccultismTags.makeItemTag(new ResourceLocation("c", "gems/" + gemName))))
                .setResultAmount(1)
                .setAllowEmpty(false)
    ...
    private void crushingMetalRecipe(String metalName, RecipeOutput recipeOutput) {
        CrushingRecipeBuilder.crushingRecipe(OccultismTags.makeItemTag(new ResourceLocation("c", "ores/" + metalName)), OccultismTags.makeItemTag(new ResourceLocation("c", "dusts/" + metalName)), 200)
                .unlockedBy("has_" + metalName, has(OccultismTags.makeItemTag(new ResourceLocation("c", "ores/" + metalName))))
                .setResultAmount(2)
                .setAllowEmpty(false)
                .save(recipeOutput, new ResourceLocation(Occultism.MODID, "crushing/" + metalName + "_dust"));

        CrushingRecipeBuilder.crushingRecipe(OccultismTags.makeItemTag(new ResourceLocation("c", "raw_materials/" + metalName)), OccultismTags.makeItemTag(new ResourceLocation("c", "dusts/" + metalName)), 200)
                .unlockedBy("has_raw_" + metalName, has(OccultismTags.makeItemTag(new ResourceLocation("c", "raw_materials/" + metalName))))
                .setResultAmount(2)
                .setAllowEmpty(false)
                .save(recipeOutput, new ResourceLocation(Occultism.MODID, "crushing/" + metalName + "_dust_from_raw"));

        CrushingRecipeBuilder.crushingRecipe(OccultismTags.makeItemTag(new ResourceLocation("c", "storage_blocks/raw_" + metalName)), OccultismTags.makeItemTag(new ResourceLocation("c", "dusts/" + metalName)), 1600)
                .unlockedBy("has_raw_" + metalName + "_block", has(OccultismTags.makeItemTag(new ResourceLocation("c", "storage_blocks/raw_" + metalName))))
                .setResultAmount(18)
                .setAllowEmpty(false)
                .save(recipeOutput, new ResourceLocation(Occultism.MODID, "crushing/" + metalName + "_dust_from_raw_block"));

        CrushingRecipeBuilder.crushingRecipe(OccultismTags.makeItemTag(new ResourceLocation("c", "ingots/" + metalName)), OccultismTags.makeItemTag(new ResourceLocation("c", "dusts/" + metalName)), 200)
                .unlockedBy("has_" + metalName + "_ingot", has(OccultismTags.makeItemTag(new ResourceLocation("c", "ingots/" + metalName))))
                .setResultAmount(1)
                .setAllowEmpty(false)
    ...
    private void craftingRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_EMPTY.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_empty"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_AFRIT.get())
                ...
                .unlockedBy("has_taboo_book", has(OccultismItems.TABOO_BOOK.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_afrit"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_AFRIT.get())
                .pattern(" p ")
                .pattern("pbp")
                .pattern(" p ")
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_afrit_from_empty"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_BOUND_AFRIT.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_bound_afrit"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_DJINNI.get())
                ...
                .define('f', OccultismItems.AWAKENED_FEATHER.get())
                .unlockedBy("has_taboo_book", has(OccultismItems.TABOO_BOOK.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_djinni"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_DJINNI.get())
                .pattern(" g ")
                .pattern("gbg")
                .pattern(" g ")
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_djinni_from_empty"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_BOUND_DJINNI.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_bound_djinni"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_BOUND_DJINNI.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_bound_djinni_from_calling"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_FOLIOT.get())
                ...
                .define('f', OccultismItems.AWAKENED_FEATHER.get())
                .unlockedBy("has_taboo_book", has(OccultismItems.TABOO_BOOK.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_foliot"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_FOLIOT.get())
                .pattern(" w ")
                .pattern("wbw")
                .pattern(" w ")
                ...
                .define('b', OccultismItems.BOOK_OF_BINDING_EMPTY.get())
                .unlockedBy("has_empty_binding", has(OccultismItems.BOOK_OF_BINDING_EMPTY.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_foliot_from_empty"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_BOUND_FOLIOT.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_bound_foliot"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_BOUND_FOLIOT.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_bound_foliot_from_calling"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_MARID.get())
                ...
                .define('f', OccultismItems.AWAKENED_FEATHER.get())
                .unlockedBy("has_taboo_book", has(OccultismItems.TABOO_BOOK.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_marid"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_MARID.get())
                .pattern(" o ")
                .pattern("pbp")
                .pattern(" o ")
                ...
                .define('b', OccultismItems.BOOK_OF_BINDING_EMPTY.get())
                .unlockedBy("has_empty_binding", has(OccultismItems.BOOK_OF_BINDING_EMPTY.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_marid_from_empty"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_BINDING_BOUND_MARID.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_binding_bound_marid"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_CALLING_DJINNI_MANAGE_MACHINE.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_calling_djinni_manage_machine"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_CALLING_FOLIOT_CLEANER.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_calling_foliot_cleaner"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_CALLING_FOLIOT_LUMBERJACK.get())
                ...
                .unlockedBy("has_book_of_binding_bound_foliot", has(OccultismItems.BOOK_OF_BINDING_BOUND_FOLIOT.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_calling_foliot_lumberjack"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.BOOK_OF_CALLING_FOLIOT_TRANSPORT_ITEMS.get())
                ...
                .unlockedBy("has_book_of_binding_bound_foliot", has(OccultismItems.BOOK_OF_BINDING_BOUND_FOLIOT.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/book_of_calling_foliot_transport_items"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.BRUSH.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/brush"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, OccultismItems.BUTCHER_KNIFE.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/butcher_knife"));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, OccultismBlocks.CANDLE_WHITE.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/candle"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.CHALK_GOLD_IMPURE.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/chalk_gold_impure"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.CHALK_PURPLE_IMPURE.get())
                ...
                .requires(OccultismTags.Items.OBSIDIAN_DUST)
                .unlockedBy("has_chalk_white", has(OccultismItems.CHALK_WHITE_IMPURE.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/chalk_purple_impure"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.CHALK_RED_IMPURE.get())
                ...
                .unlockedBy("has_chalk_white", has(OccultismItems.CHALK_WHITE_IMPURE.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/chalk_red_impure"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.CHALK_WHITE_IMPURE.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/chalk_white_impure"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, OccultismItems.DEMONS_DREAM_ESSENCE.get())
                ...
                .unlockedBy("has_datura", has(OccultismTags.Items.DATURA_CROP))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/demons_dream_essence_from_fruit"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, OccultismItems.DEMONS_DREAM_ESSENCE.get())
                .pattern("ppp")
                .pattern("ppp")
                .pattern("ppp")
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/demons_dream_essence_from_seeds"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, OccultismItems.DICTIONARY_OF_SPIRITS.get())
                ...
                .unlockedBy("has_datura", has(OccultismTags.Items.DATURA_SEEDS))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/dictionary_of_spirits"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, OccultismItems.DIVINATION_ROD.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/divination_rod"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, OccultismItems.OTHERWORLD_GOGGLES.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/goggles"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismBlocks.GOLDEN_SACRIFICIAL_BOWL.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/golden_sacrificial_bowl"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, OccultismItems.IESNIUM_PICKAXE.get())
                ...
                .define('s', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_iesnium_ingot", has(OccultismTags.Items.IESNIUM_INGOT))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/iesnium_pickaxe"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.LENS_FRAME.get())
                ...
                .unlockedBy("has_silver_ingot", has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/lens_frame"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.LENSES.get())
                ...
                .unlockedBy("has_spirit_attuned_gem", has(OccultismItems.SPIRIT_ATTUNED_GEM.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/lenses"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.MAGIC_LAMP_EMPTY.get())
                ...
                .define('i', OccultismTags.Items.IESNIUM_INGOT)
                .unlockedBy("has_silver_ingot", has(OccultismTags.Items.SILVER_INGOT))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/magic_lamp_empty"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.OTHERSTONE_FRAME.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/otherstone_frame"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.OTHERSTONE_PEDESTAL.get())
                ...
                .define('o', OccultismBlocks.OTHERSTONE.get())
                .unlockedBy("has_otherstone", has(OccultismBlocks.OTHERSTONE.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/otherstone_pedestal"));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.OTHERSTONE_SLAB.get(), 6)
                .pattern("ooo")
                .define('o', OccultismBlocks.OTHERSTONE.get())
                .unlockedBy("has_otherstone", has(OccultismBlocks.OTHERSTONE.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/otherstone_slab"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, OccultismItems.OTHERSTONE_TABLET.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/otherstone_tablet"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, OccultismBlocks.SACRIFICIAL_BOWL.get())
                ...
                .define('o', OccultismBlocks.OTHERSTONE.get())
                .unlockedBy("has_otherstone", has(OccultismBlocks.OTHERSTONE.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/sacrificial_bowl"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismBlocks.SPIRIT_ATTUNED_CRYSTAL.get())
                ...
                .define('g', OccultismItems.SPIRIT_ATTUNED_GEM.get())
                .unlockedBy("has_spirit_attuned_gem", has(OccultismItems.SPIRIT_ATTUNED_GEM.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/spirit_attuned_crystal"));

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.SPIRIT_ATTUNED_PICKAXE_HEAD.get())
                .pattern("ggg")
                .define('g', OccultismItems.SPIRIT_ATTUNED_GEM.get())
                .unlockedBy("has_spirit_attuned_gem", has(OccultismItems.SPIRIT_ATTUNED_GEM.get()))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/spirit_attuned_pickaxe_head"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismBlocks.SPIRIT_CAMPFIRE.get())
                ...
                .unlockedBy("has_datura", has(OccultismTags.Items.DATURA_CROP))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/spirit_campfire"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, OccultismBlocks.SPIRIT_LANTERN.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/spirit_lantern"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, OccultismBlocks.SPIRIT_TORCH.get())
                ...
                .define('S', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_datura", has(OccultismTags.Items.DATURA_CROP))
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/spirit_torch"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismBlocks.STORAGE_CONTROLLER.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/storage_controller"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, OccultismItems.STORAGE_REMOTE_INERT.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/storage_remote_inert"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, OccultismItems.WORMHOLE_FRAME.get())
                ...
                .save(pRecipeOutput, new ResourceLocation(Occultism.MODID, "crafting/wormhole_frame"));
