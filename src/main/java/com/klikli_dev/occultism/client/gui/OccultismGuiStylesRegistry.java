...
public final class OccultismGuiStylesRegistry {
    ...
    private OccultismGuiStylesRegistry() {
    }

    private static GuiStyle.Builder baseStyle() {
    ...
    public static void register() {
        GuiStyleRegistry.register(OccultismGuiStyles.FILTER_LIST, baseStyle()
        ...
        GuiStyleRegistry.register(OccultismGuiStyles.FILTER_ATTRIBUTE, baseStyle()
        ...
        GuiStyleRegistry.register(OccultismGuiStyles.SPIRIT_TRANSPORTER, transporterBaseStyle()
