...
public class OccultismGeoBlockEntityRenderState extends BlockEntityRenderState implements GeoRenderState {
    ...
    public double getAnimatableAge() {
        return getOrDefaultGeckolibData(DataTickets.TICK, 0.0);
    }
